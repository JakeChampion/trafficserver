...
{
  // Initialize brotli stream structure.
  // Actual encoder creation is deferred to transform_init() when we have access to HostConfiguration.
...
transform_init(Data *data)
{
  ...
  // Use configured compression level and window size from HostConfiguration
