...
{
  // Initialize zlib stream structure with zeros/nulls.
  // Actual deflateInit2 is deferred to transform_init() when we have access to HostConfiguration.
...
transform_init(Data *data)
{
  ...
  // Use configured compression level from HostConfiguration
